...
class _BaseUrl:
    ...
    def host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the encoded host, e.g if the input URL is `https://瞿瞿瞿.com`,
    ...
    def unicode_host(self) -> str | None:
        ...
        If the URL must be punycode encoded, this is the decoded host, e.g if the input URL is `https://瞿瞿瞿.com`,
        `unicode_host()` will be `瞿瞿瞿.com`
        """
    ...
    def unicode_string(self) -> str:
        ...
        If the URL must be punycode encoded, this is the decoded string, e.g if the input URL is `https://瞿瞿瞿.com`,
        `unicode_string()` will be `https://瞿瞿瞿.com`
        """
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    m1 = MyModel(url='http://puny瞿code.com')
    print(m1.url)
    #> http://xn--punycode-eja.com/
    m2 = MyModel(url='https://www.訄???迮.com/')
    print(m2.url)
