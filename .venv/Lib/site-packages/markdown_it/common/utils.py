...
def normalizeReference(string: str) -> str:
    ...
    # In node v10 '廕?.toLowerCase() === '廜?, which is presumed to be a bug
    ...
    # 襤, 炴, 廕? ?? ?? ??- those are already uppercased, but have differently
    # uppercased versions).
    #
    # Here's an example showing how it happens. Lets take greek letter omega:
    # uppercase U+0398 (?), U+03f4 (炴) and lowercase U+03b8 (庛), U+03d1 (?)
    #
    # Unicode entries:
    ...
    # and .toUpperCase() doesn't change 炴 (already uppercase).
    #
