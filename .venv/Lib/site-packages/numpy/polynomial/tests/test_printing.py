...
class TestStrUnicodeSuperSubscripts:
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚x + 3.0繚x簡"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚x + 3.0繚x簡 - 1.0繚x糧"),
        (arange(12), ("0.0 + 1.0繚x + 2.0繚x簡 + 3.0繚x糧 + 4.0繚x??+ 5.0繚x??+ "
                      "6.0繚x??+ 7.0繚x??+\n8.0繚x??+ 9.0繚x??+ 10.0繚x繒??+ "
                      "11.0繚x繒繒")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚T??x) + 3.0繚T??x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚T??x) + 3.0繚T??x) - 1.0繚T??x)"),
        (arange(12), ("0.0 + 1.0繚T??x) + 2.0繚T??x) + 3.0繚T??x) + 4.0繚T??x) + "
                      "5.0繚T??x) +\n6.0繚T??x) + 7.0繚T??x) + 8.0繚T??x) + "
                      "9.0繚T??x) + 10.0繚T??(x) + 11.0繚T??(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚P??x) + 3.0繚P??x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚P??x) + 3.0繚P??x) - 1.0繚P??x)"),
        (arange(12), ("0.0 + 1.0繚P??x) + 2.0繚P??x) + 3.0繚P??x) + 4.0繚P??x) + "
                      "5.0繚P??x) +\n6.0繚P??x) + 7.0繚P??x) + 8.0繚P??x) + "
                      "9.0繚P??x) + 10.0繚P??(x) + 11.0繚P??(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚H??x) + 3.0繚H??x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚H??x) + 3.0繚H??x) - 1.0繚H??x)"),
        (arange(12), ("0.0 + 1.0繚H??x) + 2.0繚H??x) + 3.0繚H??x) + 4.0繚H??x) + "
                      "5.0繚H??x) +\n6.0繚H??x) + 7.0繚H??x) + 8.0繚H??x) + "
                      "9.0繚H??x) + 10.0繚H??(x) + 11.0繚H??(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚He??x) + 3.0繚He??x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚He??x) + 3.0繚He??x) - 1.0繚He??x)"),
        (arange(12), ("0.0 + 1.0繚He??x) + 2.0繚He??x) + 3.0繚He??x) + "
                      "4.0繚He??x) + 5.0繚He??x) +\n6.0繚He??x) + 7.0繚He??x) + "
                      "8.0繚He??x) + 9.0繚He??x) + 10.0繚He??(x) +\n"
                      "11.0繚He??(x)")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ([1, 2, 3], "1.0 + 2.0繚L??x) + 3.0繚L??x)"),
        ([-1, 0, 3, -1], "-1.0 + 0.0繚L??x) + 3.0繚L??x) - 1.0繚L??x)"),
        (arange(12), ("0.0 + 1.0繚L??x) + 2.0繚L??x) + 3.0繚L??x) + 4.0繚L??x) + "
                      "5.0繚L??x) +\n6.0繚L??x) + 7.0繚L??x) + 8.0繚L??x) + "
                      "9.0繚L??x) + 10.0繚L??(x) + 11.0繚L??(x)")),
    ))
...
def test_set_default_printoptions():
    ...
    poly.set_default_printstyle('unicode')
    assert_equal(str(p), "1.0 + 2.0繚x + 3.0繚x簡")
    assert_equal(str(c), "1.0 + 2.0繚T??x) + 3.0繚T??x)")
...
def test_complex_coefficients():
    ...
    poly.set_default_printstyle('unicode')
    assert_equal(str(p1), "1j + (1+1j)繚x - (2-2j)繚x簡 + (3+0j)繚x糧")
    assert_equal(str(p2), "1j + (1+1j)繚x + (-2+2j)繚x簡 + (3+0j)繚x糧")
    poly.set_default_printstyle('ascii')
...
@pytest.mark.parametrize(('coefs', 'tgt'), (
    (array([1, 2, 'f'], dtype=object), '1 + 2繚x + f繚x簡'),
    (array([1, 2, [3, 4]], dtype=object), '1 + 2繚x + [3, 4]繚x簡'),
))
...
class TestFormat:
    def test_format_unicode(self):
        ...
        assert_equal(format(p, 'unicode'), "1.0 + 2.0繚x + 0.0繚x簡 - 1.0繚x糧")
...
@pytest.mark.parametrize(('poly', 'tgt'), (
    (poly.Polynomial, '1.0 + 2.0繚z + 3.0繚z簡'),
    (poly.Chebyshev, '1.0 + 2.0繚T??z) + 3.0繚T??z)'),
    (poly.Hermite, '1.0 + 2.0繚H??z) + 3.0繚H??z)'),
    (poly.HermiteE, '1.0 + 2.0繚He??z) + 3.0繚He??z)'),
    (poly.Laguerre, '1.0 + 2.0繚L??z) + 3.0繚L??z)'),
    (poly.Legendre, '1.0 + 2.0繚P??z) + 3.0繚P??z)'),
))
