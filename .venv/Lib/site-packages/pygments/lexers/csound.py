...
class CsoundOrchestraLexer(CsoundLexer):
    ...
    tokens = {
        ...
        # work with strings that contain format specifiers. In addition, these opcodes??        # handling of format specifiers is inconsistent:
        #   - fprintks and fprints accept %a and %A specifiers, and accept %s specifiers
        #     starting in Csound 6.15.0.
        #   - printks and prints accept %a and %A specifiers, but don? accept %s
        #     specifiers.
        #   - printf, printf_i, sprintf, and sprintfk don? accept %a and %A specifiers,
