...
class QVToLexer(RegexLexer):
    ...
    Reference for implementing this: 竄Meta Object Facility (MOF) 2.0
    Query/View/Transformation Specification罈, Version 1.1 - January 2011
    (https://www.omg.org/spec/QVT/1.1/), see 禮8.4, 竄Concrete Syntax罈 in
    particular.
